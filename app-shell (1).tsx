...
export function AppShell({
  ...
  return (
    <div className="surface-warm flex min-h-screen justify-center">
      <div className="flex min-h-screen w-full max-w-lg flex-col border-border bg-background/60 sm:border-x">
        <main key={pathname} className={cn("page-enter flex-1 pb-6", className)}>
          {children}
        </main>
        {nav ? <BottomNav /> : null}
      </div>
