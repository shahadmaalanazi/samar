    ...
    <header className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 px-5 pb-4 pt-6">
      {back ? (
        <button
          ...
          aria-label="رجوع"
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-border bg-card text-foreground transition-colors hover:bg-secondary cursor-pointer"
        >
      ...
      <div className="min-w-0 text-center flex items-center justify-center gap-2">
        <img src="/logo.png" alt="شعار سمر" className="h-7 w-auto object-contain shrink-0" />
        <div>
