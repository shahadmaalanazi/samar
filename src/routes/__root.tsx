...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تطبيق سمر لاكتشاف التراث السعودي بالقصص الصوتية والذكاء الاصطناعي." },
      { name: "author", content: "SAMAR" },
      { property: "og:title", content: "سمر — حيث تحكي الأماكن قصصها" },
      { property: "og:description", content: "اكتشف التراث السعودي بالصوت والقصة." },
